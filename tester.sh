...
gen_arg() {
    ...
    local MIN_VAL=1
    local MAX_VAL=$((1000 > 2 * N ? 1000 : 2 * N)) # Garante um intervalo mínimo, e grande o suficiente
...
grep -E "Algorithm|Sorting End" output.$N_ARGS.txt 

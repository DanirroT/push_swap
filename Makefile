...
#    Updated: 2026/01/08 14:26:38 by dmota-ri         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = push_swap

SRC = push_swap_main.c push_swap_utils.c push_swap_prints.c\
	push_swap_operations_dup.c push_swap_operations.c\
	push_swap_simple_solve.c\
	push_swap_push_to_side_sort.c push_swap_push_to_side_sort_empty.c\
	push_swap_rotate_to_side.c\
	push_swap_radix.c push_swap_chunking.c

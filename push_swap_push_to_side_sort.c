...
/*   Updated: 2025/12/10 19:02:56 by dmota-ri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	push_to_side(t_stack stack, t_sizes stack_sizes, int print)
{
	...
	while (!check_sort(stack.a, stack_sizes.a, 1) || stack_sizes.b != 0)
	{
		...
		{
			actions += do_pass_b(stack, &stack_sizes, print);
			actions += do_swap(stack.a, stack_sizes.a, print * 'a');
		}
	}
	return (actions);
}
